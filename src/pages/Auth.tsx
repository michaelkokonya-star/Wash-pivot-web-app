...
import { Mail, Lock, User, ArrowRight, Loader2, AlertCircle, CheckCircle2, Facebook, LayoutGrid } from 'lucide-react';
...
const Auth = () => {
  ...
  const handleSignIn = async (provider: 'google' | 'facebook' | 'microsoft' = 'google') => {
    setError(null);
    setLoading(true);
    try {
                  ...
                  <div className="grid grid-cols-1 gap-3">
                    ...
                    <div className="grid grid-cols-2 gap-3">
                      <button
                        ...
                        disabled={loading}
                        className="bg-[#1877F2] text-white rounded-2xl py-4 font-bold text-sm flex items-center justify-center space-x-3 hover:bg-[#166fe5] transition-all disabled:opacity-50"
                      >
                        <Facebook size={20} />
                        <span>Facebook</span>
                      </button>
                      ...
                      <button
                        ...
                        disabled={loading}
                        className="bg-[#00a4ef] text-white rounded-2xl py-4 font-bold text-sm flex items-center justify-center space-x-3 hover:bg-[#0096da] transition-all disabled:opacity-50"
                      >
                        <LayoutGrid size={20} />
                        <span>Microsoft</span>
                      </button>
