  ...
  return (
    ...
    >
      <div className="text-center mb-20">
        <h1 className="text-6xl font-bold tracking-tighter mb-6">ABOUT WASH PIVOT</h1>
      ...
      <div className="bg-black text-white p-16 rounded-[40px] overflow-hidden relative">
        <div className="relative z-10 max-w-2xl">
          <h2 className="text-4xl font-bold tracking-tighter mb-6">OUR STORY</h2>
          ...
          <div className="flex space-x-12">
            ...
            <div>
              ...
              <div className="text-xs uppercase tracking-widest text-white/40 font-bold">Lives Impacted</div>
            </div>
          </div>
        </div>
        <div className="absolute top-0 right-0 w-1/2 h-full bg-emerald-500/10 blur-[120px] rounded-full -translate-y-1/2 translate-x-1/4"></div>
      </div>
    </motion.div>
  );
};
